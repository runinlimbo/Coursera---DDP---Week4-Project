...
Source code for the web application can be found at the following link: 
...
## Calorie Expenditure Web Application Model Output
...
```{r pressure, echo=FALSE, out.width = '100%',out.height='50%'}
