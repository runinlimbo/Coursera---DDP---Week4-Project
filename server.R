...
server <- (function(input, output) {
  ...
  output$description <- renderText({
    "The calculator estimates total calories burned during a workout.  
     
Simply enter the input in the left panel to determine total calories burned.  
     
The equation used to estimate Calories is based on results presented in the March 2005 publication of the Journal of Sports Sciences, 'Prediction of energy expenditure from heart rate monitoring during submaximal exercise.'"
